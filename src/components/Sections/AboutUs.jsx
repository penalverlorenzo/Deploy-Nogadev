export const AboutUs = () => {
  return (
    <div className="mx-auto px-4 relative max-w-7xl sm:px-6 dark:bg-gray-800">

    <div className="flex items-center  mb-20">
      <div className="mx-auto max-w-5xl md:pb-16 pb-10 text-start">
        <p className="font-bold text-base text-[#1e3a8a] dark:text-[#bfdbfe] tracking-wide uppercase">About us</p>
        <h1 className="font-bold font-heading leading-tighter tracking-tighter mb-4 text-black md:text-6xl text-5xl dark:text-white">
          Enhance your digital footprint with our<br />
          <a className="highlight text-[#6d28d9]" href="/#services">Services</a>
        </h1>
        <div className="mx-auto max-w-3xl">
          <p className="text-xl text-[#101010e6] dark:text-white/80 mb-6">
