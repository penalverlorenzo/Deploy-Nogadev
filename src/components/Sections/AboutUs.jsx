...
export const AboutUs = () => {
  return (
    <div className="mx-auto px-4 relative w-full sm:px-6 bg-white py-12 " id="about">
      ...
      <div className="container">
        <Advertising className="flex flex-col items-center gap-8 pt-12">
          <h2 className="text-4xl extraBold mx-auto text-center">Meet our Team</h2>
          <p className="text-2xl font-medium mx-auto text-center">
            Our team is made up of talented and passionate individuals who are dedicated to helping you achieve your goals. We are committed to provide you with the best possible service and support. We are here to help you every step of the way.
          </p>
          <Team />
        </Advertising>
      </div>
