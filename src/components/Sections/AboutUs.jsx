...
export const AboutUs = () => {
  ...
  return (
    <div className="mx-auto px-4 relative max-w-7xl sm:px-6 dark:bg-[#1f2937]">

    <div className="flex items-center  mb-20">
      <div className="mx-auto max-w-5xl md:pb-16 pb-10 text-start">
        <p className="font-bold text-base text-[#1e3a8a] tracking-wide uppercase my-5 ml-2">{about.name}</p>
