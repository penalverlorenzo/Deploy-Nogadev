...
function ChatBotContain() {
  ...
  return (
    ...
    <div className={`fixed bottom-8 left-5 `}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className={`icon icon-tabler icon-tabler-affiliate-filled cursor-pointer`} onClick={() => toggle ? setToggle(false) : setToggle(true)} width="54" height="54" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
